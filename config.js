...
const CONFIG = {
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "C & C HOUSE RENOVATIONS (PTY) LTD — Plumber in johannesburg",
    description: "C & C HOUSE RENOVATIONS (PTY) LTD provides professional plumber in Johannesburg. 7 Google reviews. Call for a quote today.",
  ...
  content: {
    ...
    heroLead:   "C & C HOUSE RENOVATIONS (PTY) LTD provides fast, reliable plumbing services for homes and businesses across Johannesburg and the surrounding areas. Emergency callouts welcome.",
    ...
    band: {
      ...
      alt:   "C & C HOUSE RENOVATIONS (PTY) LTD team at work in Johannesburg",
